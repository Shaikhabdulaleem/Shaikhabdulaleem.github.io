...
const handoffSteps = [
  ...
  },
  {
    ...
    detail: 'Choose a live 60-minute Google Meet slot in your own timezone.',
    color: '#c084fc',
        ...
        <div className="relative mt-20">
          <div className="hidden md:block absolute left-[12%] right-[12%] top-10 h-px bg-gradient-to-r from-cyan-500/20 via-emerald-400/50 to-purple-500/20">
            <motion.span
              ...
              animate={{ left: ['0%', '99%'], opacity: [0, 1, 1, 0] }}
            ...
            {handoffSteps.map((step, index) => (
              ...
              >
                <div className="flex md:flex-col items-start md:items-center gap-5 md:gap-0">
                  ...
                  >
                    <span className="absolute inset-2 rounded-full border border-dashed opacity-30 animate-[spin_8s_linear_infinite]" style={{ borderColor: step.color }} />
                    {step.code}
                  </div>
        ...
        <div className="mt-24 pt-8 border-t border-gray-900 flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
          <div>
            ...
            <div className="flex items-end gap-3 mt-2">
              <span className="text-6xl md:text-7xl font-black tracking-tighter text-white">60</span>
              <span className="text-sm font-mono text-purple-300 pb-2">MIN / GOOGLE MEET</span>
            </div>
          </div>
